    ...
    <nav className=" py-1 bg-[]  ">
      <div className="container-wrapper flex items-center justify-between relative">
        <div className=" flex items-center gap-2">
          ...
          <p className=" text-3xl font-bold font-groot-one text-[#fff]">
            GrootSol
          </p>
        </div>
        ...
        <div className="flex items-center space-x-6">
          <div className="flex items-center space-x-4 text-xl [&_a:hover]:opacity-70">
            <a target="_blank" href="https://twitter.com/BabyGroottt" className=" text-4xl">
              <FaTwitter fill="#fff" />
            </a>
            <a target="_blank" href="https://t.me/grootsol" className=" text-4xl">
              <FaTelegram fill="#fff" />
            </a>
          </div>
